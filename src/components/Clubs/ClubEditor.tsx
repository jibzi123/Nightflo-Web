...
const ClubEditor: React.FC<ClubEditorProps> = ({
  club,
  isOpen,
  onClose,
  onSave,
                ...
                >
                  <div
                    style={{
                      ...
                      borderRadius: "50%",
                      margin: "0 auto 12px",
                      background: formData.ownerProfilePicture
                        ? `url(${formData.ownerProfilePicture})`
                        : "#f1f5f9",
              ...
              >
                ...
                >
                  ...
                  <p style={{ color: "#92400e", fontSize: "12px", margin: 0 }}>
                    Changing the password will require the club owner to log in
                    with the new credentials. Make sure to communicate the new
                    password securely.
                  </p>
                </div>
              </div>
