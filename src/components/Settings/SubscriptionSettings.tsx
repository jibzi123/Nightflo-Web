...
const PlanChangeModal: React.FC<PlanChangeModalProps> = ({
  ...
  const isUpgrade = (newPlan: string) => {
    ...
    return (
      planOrder[newPlan as keyof typeof planOrder] > planOrder[currentPlan]
    );
  };
            ...
            {Object.entries(plans).map(([planKey, plan]) => (
              <div
                ...
                style={{
                  ...
                  cursor: "pointer",
                  background:
                    selectedPlan === planKey ? `${plan.color}08` : "#323232",
...
const SubscriptionSettings: React.FC = () => {
  ...
  const handleCancelSubscription = () => {
    ...
    alert(
      "Subscription cancelled. You will continue to have access until your current billing period ends."
    );
  };
          ...
          {isSubscriptionExpiringSoon() && subscription.status === "active" && (
            ...
            >
              ...
              <span style={{ fontSize: "13px" }}>
                Your subscription expires soon. Make sure auto-renewal is
                enabled to avoid service interruption.
              </span>
            </div>
          )}
        </div>
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              <p style={{ color: "#A5A5A5", fontSize: "14px" }}>
                ...
                {new Date(subscription.endDate).toLocaleDateString()}, and
