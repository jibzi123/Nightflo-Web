...
const ClubSettings: React.FC = () => {
  const [clubData, setClubData] = useState<ClubData>({
    ...
    capacity: 500,
    description:
      "Premium nightclub experience with world-class DJs and VIP services.",
    profileImage:
    ...
    complianceDocuments: [
      ...
      },
      {
        ...
        fileUrl: "#",
        adminComments:
          "Coverage amount insufficient. Please update policy to minimum $2M liability.",
  ...
  const handleImageUpload = (type: "club" | "owner" | "gallery") => {
    const mockImageUrl = `https://images.pexels.com/photos/${Math.floor(
      Math.random() * 1000000
    )}/pexels-photo.jpeg?auto=compress&cs=tinysrgb&w=400`;
          ...
          >
            ...
            >
              <div
                style={{
                  ...
                  borderRadius: "12px",
                  margin: "0 auto 12px",
                  background: clubData.profileImage
                    ? `url(${clubData.profileImage})`
                    : "#f1f5f9",
              ...
              <button
                ...
                className="btn btn-secondary-outlined" /* Keep as is */
              >
                <Upload size={16} />
                Upload Club Photo
              </button>
            ...
            <div className="form-group" style={{ gridColumn: "1 / -1" }}>
              ...
              <input
                ...
                onChange={(e) =>
                  setClubData((prev) => ({ ...prev, address: e.target.value }))
                }
              />
            </div>
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={(e) =>
                  setClubData((prev) => ({ ...prev, phone: e.target.value }))
                }
              />
            </div>
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={(e) =>
                  setClubData((prev) => ({ ...prev, email: e.target.value }))
                }
              />
            </div>
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={(e) =>
                  setClubData((prev) => ({ ...prev, website: e.target.value }))
                }
              />
            </div>
